...
{
    public partial class FluxGSA : Form
    {
        IFluxSDK _sdk;
        IFluxLogger _log;
        IGSACommand _command;
        ...
        public FluxGSA()
        {
            ...
            _log.Info("Loading Flux GSA Controller");

            //app settings
            string clientID = ConfigurationManager.AppSettings["FluxClientID"];
            string clientVersion = ConfigurationManager.AppSettings["FluxClientVersion"];
        ...
        private void FluxGSA_Load(object sender, EventArgs e)
        {
        ...
        private void btnReceive_Click(object sender, EventArgs e)
        {
            if (_command == null)
            {
                MessageBox.Show("A GSA file must be open to receive data from Flux. " +
                    "Use File > Open GSA Model...");
                return;
            }
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            if(_command == null)
            {
                MessageBox.Show("A GSA file must be open to send data to Flux. " +
                    "Use File > Open GSA Model...");
                return;
            }
        ...
        private void Login()
        {
            try
            {
                ...
                _sdk.Login(
                    ConfigurationManager.AppSettings["FluxClientSecret"], 
